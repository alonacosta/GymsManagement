...
namespace GymManagement.Migrations
{
    ...
    [Migration("20241112183321_AddRateIntNumber")]
    partial class AddRateIntNumber
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymManagement.Data.Entities.Equipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.Data.Entities.FreeAppointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.Data.Entities.GymEquipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.Data.Entities.GymSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.Data.Entities.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymManagement.Data.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("GymManagement.Data.Entities.GymSession", "GymSession")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("GymManagement.Data.Entities.City", b =>
                {
                    b.HasOne("GymManagement.Data.Entities.Country", "Country")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("GymManagement.Data.Entities.GymEquipment", b =>
                {
                    b.HasOne("GymManagement.Data.Entities.Equipment", "Equipment")
